...
- [xcel] (https://github.com/o2team/xcel) 一个基于 Electron 和 Vue 的 Excel 数据过滤工具
...
### 图形 && 动画
- [rough](https://github.com/pshihn/rough) 生成手绘风格的图形。Create graphics with a hand-drawn, sketchy, appearance 
